...
const isDelegateAuthenticateMiddleware = async (req, res, next) => {
  try {
    ...
    console.error("Error in isVendorAuthenticateMiddleware:", error);
...
module.exports = isDelegateAuthenticateMiddleware;